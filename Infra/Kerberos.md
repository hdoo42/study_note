...
---
**1. 근본적 원리 (Rationale)**
Kerberos는 신뢰할 수 없는 네트워크(Unsecured Network) 상에서 신뢰할 수 있는 제3자(KDC)를 통해 **대칭키 암호화 방식([Symmetric encryption](Infra/Symmetric%20encryption.md))**만을 사용하여 비밀번호 전송 없이 사용자와 서비스 간의 상호 신원을 검증하기 위해 존재합니다.
