...
3. **Prior Knowledge**: Human-designed biases, such as [[CNN 1|convolutional neural networks]] (CNNs) assuming spatial locality in images.
...
- 신경망 → **Neural Network**  
- 뉴런 → **Neuron**  
- 은닉층 → **[[hidden_layer 1|Hidden Layer]]**  
- 은닉뉴런 → **[[hidden_neouron 1|Hidden Neouron]]**  
- 가중치 → **Weight**  
- 편향 → **Bias**  
