...
#### **2. 수학적 정의**  
일반적인 1D 연속 신호([[one_D_continuous_signal 1|1D Continuous Signal]]) $f(x)$와 필터 $g(x)$의 컨볼루션은 다음과 같이 정의됩니다.
...
3. **스파셜 로컬리티 ([[spatial_locality 1|Spatial Locality]])**  
